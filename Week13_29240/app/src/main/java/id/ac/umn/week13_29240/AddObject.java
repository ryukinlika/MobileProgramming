    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!objMS.getDesc().equalsIgnoreCase(
                        etDesc.getText().toString())){
                    objMS.setDesc(etDesc.getText().toString());
                }
                Intent intentReply = new Intent();
                intentReply.putExtra("type",objMS.getType());
                intentReply.putExtra("desc",objMS.getDesc());
                intentReply.putExtra("radius",objMS.getRadius());

//                Log.d("Radius intent", Double.toString(objMS.getRadius()));
                ...
                intentReply.putExtra("points",dPoints);
                    ...
                    case 0:
                        ...
                        if(mMap != null){
                            ...
                            mMap.addMarker(new
                                    ...
                                    .title(etDesc.getText().toString()));
                            objMS = new MarkerAndShape("Marker",
                                    etDesc.getText().toString(),0.0,
                                    points);
                        ...
                        if(mMap != null){
                            ...
                            if(rad.length() > 0
                                ...
                                mMap.addCircle(new CircleOptions()
                                        .radius(radius).center(points.get(0))
