package id.ac.umn.week03_29240;
...
public class DaftarKataAdapter extends RecyclerView.Adapter<DaftarKataAdapter.KataViewHolder>{
    ...
    class KataViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            String element = mDaftarKata.get(mPos);
            mDaftarKata.set(mPos, element + " clicked");
            mAdapter.notifyDataSetChanged(); //not best practice??
            Toast.makeText(v.getContext(), element + " picked", Toast.LENGTH_LONG).show();
